...
## Linear quadratic regulation (LQR) on a finite horizon
...
We can express $\bar{\bm x}$ as a function of $\bar{\bm u}$ and $\bm x_0$. This can be done in a straightforward way using (@eq-linear_system_linear_constraints_matrix_format), namely, 
$$
