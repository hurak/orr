...
Although the book is not freely available online (only the first three pages are downloadable on the authors' web page), it is available in a decent number of copies in [the university library](https://aleph.cvut.cz/F?func=direct&doc_number=000664179&local_base=DUPL&format=999). 
