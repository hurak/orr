---
title: "Indirect approach to LQR on a finite time horizon"
bibliography: 
...
The three necessary conditions of optimality are 
$$\boxed{
\begin{aligned}
...
Provided $\mathbf R>0$, we can express $\bm u$ from the third equation (aka the equation of stationarity) 
$$\boxed{
...
This is a set of 2$n$ differential equations of first order (we assume that $\bm x\in \mathbb R^n$). We need $2n$ boundary values to fully specify the solution. Where do we get them? 
