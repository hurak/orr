...
The topic of robust control is also described in a wealth of books. But unlike in the area of optimization and general optimal control, here we do have a strong preference for a single book, and our choice is fairly confident: @skogestadMultivariableFeedbackControl2005. We are going to use it in the last third of the course. A few copies of this book are available in the university library (reserved for the students of this course). In addition, the whole book has been made freely downloadable on the author's web page. We strongly recommend getting either version of the book. It may be very useful as a reference even after passing an exam in this course. 
