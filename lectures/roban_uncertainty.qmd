...
After choosing the nominal values of the parateres to be, say, in the middle of the intervals, we can express the uncertain parameters as 
...
![The two-real-pole system with uncertain location of poles modelled as two integrators with uncertain gain in the feedback](figures/multiple_uncertain_parameters_as_structured_uncertainty_1.png){#fig-multiple-uncertain-parameters-1 width=70%}

We can then isolate the uncertain parameters as in @fig-multiple-uncertain-parameters-2.

![Modification of @fig-multiple-uncertain-parameters-1 so that the uncertain parameters are isolated](figures/multiple_uncertain_parameters_as_structured_uncertainty_2.png){#fig-multiple-uncertain-parameters-2 width=70%}
