...
\begin{aligned}
 ...
 \bm x_2 &= \mathbf A\mathbf x_1 + \mathbf B\bm u_1\\
     &= \mathbf A(\mathbf A\mathbf x_0 + \mathbf B\bm u_0)+ \mathbf B\bm u_1\\
     &= \mathbf A^2\mathbf x_0 + \mathbf A\mathbf B\bm u_0 + \mathbf B\bm u_1\\
     &\vdots\\
...
\begin{aligned}
 ...
 \text{subject to} & \begin{bmatrix}
                 ...
                 \leq
                 \begin{bmatrix}
                  \mathbf u^\mathrm{max} \\ \mathbf u^\mathrm{max} \\ \vdots \\ \mathbf u^\mathrm{max}\\ -\mathbf u^\mathrm{min} \\ -\mathbf u^\mathrm{min} \\ \vdots \\ -\mathbf u^\mathrm{min}
                 \end{bmatrix}.
 \end{aligned}
$$ 
