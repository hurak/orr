...
$$
\begin{aligned}
    \dot{\mathbf{x}}(t) &= \begin{bmatrix}1 & 1\\0 & 1\end{bmatrix}\mathbf x(t)+\begin{bmatrix}0\\1\end{bmatrix}u(t)
...
nyquistplot(L_lqg,title="",xlabel="Real",ylabel="Imaginary",legend=false,lw=2,aspect_ratio=1)
```
