...
We did not discuss the proof of Pontryagin's principle and we do not even command the students to go through the proof in the book. Admittedly, it is rather challenging. But understanding the result, its roots in calculus of variations, and how it removes the deficiencies of the calculus of variations will suffice for our purposes.
...
Among numerous online resources, the lecture notes @evansIntroductionMathematicalOptimal can be recommended.