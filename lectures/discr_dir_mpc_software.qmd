...
- [acados](https://docs.acados.org) – free & open source; intervaces to Octave/Matlab, Python, C++.
- [CasADi](https://web.casadi.org) – free & open source; intervaces to Octave/Matlab, Python, C++.
