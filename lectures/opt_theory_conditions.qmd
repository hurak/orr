...
#| fig-cap: "Quadratic function with a minimum"
#| fig-subcap: 
#|  - "Surface plot"
#|  - "Contour plot"
#| layout-ncol: 2
...
p1 = surface(x1_data, x2_data, f_data, xlabel="x₁", ylabel="x₂", zlabel="f(x)", colorbar=false)
display(p1)

# Create the second plot (contour)
p2 = contour(x1_data, x2_data, f_data, xlabel="x₁", ylabel="x₂")
# Add the stationary point to the contour plot
scatter!([x_stationary[1]], [x_stationary[2]], marker=:circle, label="Stationary point")
display(p2)
```
:::
...
#| fig-cap: "Quadratic function with a saddle point"
#| fig-subcap: 
#|  - "Surface plot"
#|  - "Contour plot"
#| layout-ncol: 2
...
- The matrix `Q` is positive semidefinite, which generally means that optimality cannot be concluded. But in this particular case of a quadratic function, there are no higher-order terms in the Taylor series expansion, so the function attains the minimum at all stationary points. 

Surface and contour plots of the function are shown below.

```{julia}
#| label: fig-quadratic_surface_singular
#| fig-cap: "Quadratic function with a singular point"
#| fig-subcap: 
#|  - "Surface plot"
#|  - "Contour plot"
#| layout-ncol: 2
...
# Create a 2x1 layout for the plots
p1 = surface(x1_data, x2_data, f_data, xlabel="x₁", ylabel="x₂", zlabel="f(x)", colorbar=false)
display(p1) # This is only need here for Quarto to render the two subfigures side by side.
...
#| fig-cap: "Singular point of a non-quadratic function that turns out to be a minimum"
#| fig-subcap: 
#|  - "Surface plot"
#|  - "Contour plot"
#| layout-ncol: 2
...
p2 = contour(x1_data, x2_data, f_data, xlabel="x₁", ylabel="x₂")
# Add the stationary point to the contour plot
scatter!([0.0], [0.0], marker=:circle, label="Stationary point")
display(p2)
```
:::
