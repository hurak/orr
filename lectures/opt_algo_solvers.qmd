...
Similarly, users of Julia and JuMP will find the [list of solvers supported by JuMP](https://jump.dev/JuMP.jl/stable/installation/#Supported-solvers) useful. The list is worth consulting even if Julia is not the tool of choice, as many solvers are independent of Julia. 
