...
In this simple example a formula can be written down upon inspection: $\frac{\partial f(\mathbf x)}{\partial x_1} = 2x_i$:
``` {julia}
x₀ = rand(10)
∇f_1_exact = 2*x₀[1]
```
...
#TODO: in the meantime, have a look at [@grosNumericalOptimalControl2022, Chapter 5], or [@martinsEngineeringDesignOptimization2022, Section 6.6].