...
- In Julia, design an LQ-optimal controller that gets the quadrotor from the initial to the final state in the shortest possible time you can achieve while respecting the constraints on the input and the state variable. 
- For your solution to be accepted, you need to get to the vicinity of the final state within 3 seconds.
- We `ControlSystemsBase` for the LQ-optimal controller synthesis.
...
**The top three solutions will be awarded bonus 10% to the practial (open-book) part of the final exam.**
